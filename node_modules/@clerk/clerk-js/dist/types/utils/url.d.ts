...
export declare const LEGACY_DEV_SUFFIXES: string[];
export declare const CURRENT_DEV_SUFFIXES: string[];
...
export declare const appendAsQueryParams: (baseUrl: string | URL, values?: Record<string, string | null | undefined>) => string;
...
export declare const isAllowedRedirectOrigin: (_url: string, allowedRedirectOrigins: Array<string | RegExp> | undefined) => boolean;
